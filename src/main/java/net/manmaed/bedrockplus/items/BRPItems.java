...
public class BRPItems {
    ...
    public static final RegistryObject<Item> BR_STONEBRICKS = ITEMS.register(name("stonebricks"), () -> new BlockItem(BRPBlocks.BR_STONEBRICKS.get(), new Item.Properties().tab(BedRockPlus.itemGropup)));
    public static final RegistryObject<Item> BR_GLASS = ITEMS.register(name("clear_glass"), () -> new BlockItem(BRPBlocks.BR_GLASS.get(), new Item.Properties().tab(BedRockPlus.itemGropup)));
    public static final RegistryObject<Item> BR_CLEARGLASS = ITEMS.register(name("glass"), () -> new BlockItem(BRPBlocks.BR_CLEARGLASS.get(), new Item.Properties().tab(BedRockPlus.itemGropup)));

    public static final RegistryObject<Item> BR_GLOWSTONE = ITEMS.register(name("glowstone"), () -> new BlockItem(BRPBlocks.BR_GLOWSTONE.get(), new Item.Properties().tab(BedRockPlus.itemGropup)));
